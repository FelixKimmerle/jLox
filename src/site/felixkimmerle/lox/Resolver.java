...
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    private void endScope() {
        for (Map.Entry<String, Token> entry : unused.entrySet()) {
            Lox.error(entry.getValue(), entry.getKey() + " is declared but never used.");
        }
        unused.clear();
        scopes.pop();
    }
    ...
    @Override
    public Void visitExprBlockExpr(Expr.ExprBlock expr) {
        return null;
    }
